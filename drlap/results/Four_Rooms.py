...
from models.actor_critic_agents import SAC_Discrete
...
config.environment = Four_Rooms_Environment(height, width, stochastic_actions_probability=0.0,
                                            random_start_user_place=True, random_goal_place=random_goal_place)
...
if __name__ == '__main__':
    AGENTS = [DDQN, SAC_Discrete]  # DIAYN] # A3C] #SNN_HRL] #, DDQN]
