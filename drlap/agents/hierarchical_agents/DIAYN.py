...
from models.actor_critic_agents.SAC import SAC
...
class DIAYN(BaseAgent):
    ...
    def __init__(self, config):
        ...
        self.agent = SAC(
            self.agent_config)  # We have to use SAC because it involves maximising the policy's entropy over actions which is also a part of DIAYN
