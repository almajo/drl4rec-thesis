...
class SNN_HRL(BaseAgent):
    ...
    def create_skill_training_agent(self):
        ...
        self.skill_agent_config.environment = Skill_Wrapper(copy.deepcopy(self.environment),
    ...
    def create_manager_agent(self, skill_agent):
        ...
        self.manager_config.environment = Manager_Frozen_Worker_Wrapper(copy.deepcopy(self.environment),
                                                                        self.num_skills,
