...
class h_DQN(BaseAgent):
    ...
    def __init__(self, config):
        ...
        self.meta_controller.q_network_local = self.create_NN(input_dim=self.state_size,
    ...
    def step(self):
        ...
        while not self.episode_over:
            ...
            self.save_experience(memory=self.meta_controller.memory,
                                 experience=(
                                     self.meta_controller_state, self.subgoal, self.cumulative_meta_controller_reward,
